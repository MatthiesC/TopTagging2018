...
def run(fname_stat, fname_sys, outname_stat, outname_sys, calc_sfs = True, write_report = False):
    ...
    if '400to480' in fname_sys and 'PUPPI' in fname_sys and "wp1" in fname_sys:
        ...
        rate_unc_QCD = math.log(2.1)
        rate_unc_WJets = math.log(1.3)
    if '480to600' in fname_sys and 'PUPPI' in fname_sys and "wp1" in fname_sys:
        TagEffi_3prong_unc = 0.5
        TagEffi_2prong_unc = 0.5
        TagEffi_1prong_unc = 0.5
    ...
    # CHS
    # wp 4
    if '300to400' in fname_sys and 'CHS' in fname_sys and "wp4" in fname_sys:
        rate_unc_QCD = math.log(1.5)
        rate_unc_WJets = math.log(1.4)
    ...
    # model_stat.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar, procname='mergedTop_2016v3',obsname='*')
    # model_sys.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar , procname='mergedTop_2016v3',obsname='*')
    # model_stat.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar, procname='semimergedTop_2016v3',obsname='*')
    # model_sys.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar , procname='semimergedTop_2016v3',obsname='*')
    # model_stat.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar, procname='notmergedTop_2016v3',obsname='*')
    # model_sys.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar , procname='notmergedTop_2016v3',obsname='*')

    model_stat.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar, procname='TTbar_mergedTop_2016v3',obsname='*')
    model_sys.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar , procname='TTbar_mergedTop_2016v3',obsname='*')
    model_stat.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar, procname='TTbar_semimerged_2016v3',obsname='*')
    model_sys.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar , procname='TTbar_semimerged_2016v3',obsname='*')
    model_stat.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar, procname='TTbar_notmerged_2016v3',obsname='*')
    model_sys.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar , procname='TTbar_notmerged_2016v3',obsname='*')

    print 'add lognormal uncert BKG'
    model_sys.add_lognormal_uncertainty('SingleTop_rate', rate_unc_SingleTop, procname='SingleTop_mergedTop_2016v3',obsname='*')
    model_sys.add_lognormal_uncertainty('SingleTop_rate', rate_unc_SingleTop, procname='SingleTop_semimerged_2016v3',obsname='*')
    model_sys.add_lognormal_uncertainty('SingleTop_rate', rate_unc_SingleTop, procname='SingleTop_notmerged_2016v3',obsname='*')
    model_sys.add_lognormal_uncertainty('WJets_rate', rate_unc_WJets, procname='WJets_2016v3',obsname='*')
    model_sys.add_lognormal_uncertainty('DY_rate', rate_unc_DY, procname='DYJets_2016v3',obsname='*')
    model_sys.add_lognormal_uncertainty('QCD_rate', rate_unc_QCD, procname='QCD_2016v3',obsname='*')
    # model_sys.add_lognormal_uncertainty('BKG_rate', rate_unc_BKG, procname='Backgrounds_2016v3',obsname='*')
...
for wp in wps:
    ...
    if calculate_scaleFactors:
        ...
        WriteEffGraphs_separate(outdir+"ScaleFactors_FSR_f_prongs/2016/eff_hists_PUPPI"+wp+".root", dicts_stat, dicts_sys, bins)
...
for wp in wpsHOTVR:
    ...
    if calculate_scaleFactors:
        ...
        WriteEffGraphs_separate(outdir+"ScaleFactors_FSR_f_prongs/2016/eff_hists_HOTVR"+wp+".root", dicts_stat_HOTVR, dicts_sys_HOTVR, bins)
...
for wp in wpsCHS:
    ...
    if calculate_scaleFactors:
        ...
        WriteEffGraphs_separate(outdir+"ScaleFactors_FSR_f_prongs/2016/eff_hists_CHS"+wp+".root", dicts_stat_CHS, dicts_sys_CHS, bins)
