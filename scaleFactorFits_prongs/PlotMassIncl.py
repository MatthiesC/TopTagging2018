...
for jet in jets:
    rootname=PathRootFile+"thetaFile_massincl_"+year+"_"+jet+".root"
    plotname="PreFit_massincl_"+year+"_"+jet
    ...
    os.chdir(PathPlots)
    os.system("epstopdf PreFit_massincl_"+year+"_"+jet+"_Main_mass.eps")
