...
for jet in jets:
    rootname=PathRootFile+"thetaFile_subbtag_incl_"+year+"_"+jet+".root"
    plotname="subbtag_incl_"+year+"_"+jet
    ...
    os.chdir(PathPlots)
    os.system("epstopdf subbtag_incl_"+year+"_"+jet+"_Main_subbtag.eps")
