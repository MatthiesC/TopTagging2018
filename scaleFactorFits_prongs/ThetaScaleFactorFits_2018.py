...
def run(fname_stat, fname_sys, outname_stat, outname_sys, calc_sfs = True, write_report = False):
    ...
    if '400to480' in fname_sys and 'PUPPI' in fname_sys and "wp5" in fname_sys:
        ...
        rate_unc_QCD = math.log(1.6)
        rate_unc_WJets = math.log(1.4)
    if '_600' in fname_sys and 'PUPPI' in fname_sys and "wp5" in fname_sys:
        TagEffi_3prong_unc = 0.5
        TagEffi_2prong_unc = 0.3
        TagEffi_1prong_unc = 0.3
        rate_unc_QCD = math.log(1.5)
    ...
    # CHS
    # WP2
    if '300to400' in fname_sys and 'CHS' in fname_sys and "wp2" in fname_sys:
        if "btag" in fname_sys:
            rate_unc_QCD = math.log(1.5)
            rate_unc_WJets = math.log(1.4)
    ...
    if '300to400' in fname_sys and 'CHS' in fname_sys and "wp5" in fname_sys:
        rate_unc_QCD = math.log(1.8)
    if '400to480' in fname_sys and 'CHS' in fname_sys and "wp5" in fname_sys:
        if "btag" in fname_sys:
            rate_unc_QCD = math.log(1.5)
            rate_unc_WJets = math.log(1.4)
    ############################################################################
    ...
    # model_stat.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar, procname='mergedTop_2018',obsname='*')
    # model_sys.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar , procname='mergedTop_2018',obsname='*')
    # model_stat.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar, procname='semimergedTop_2018',obsname='*')
    # model_sys.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar , procname='semimergedTop_2018',obsname='*')
    # model_stat.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar, procname='notmergedTop_2018',obsname='*')
    # model_sys.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar , procname='notmergedTop_2018',obsname='*')

    model_stat.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar, procname='TTbar_mergedTop_2018',obsname='*')
    model_sys.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar , procname='TTbar_mergedTop_2018',obsname='*')
    model_stat.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar, procname='TTbar_semimerged_2018',obsname='*')
    model_sys.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar , procname='TTbar_semimerged_2018',obsname='*')
    model_stat.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar, procname='TTbar_notmerged_2018',obsname='*')
    model_sys.add_lognormal_uncertainty('TTbar_rate', rate_unc_TTbar , procname='TTbar_notmerged_2018',obsname='*')

    print 'add lognormal uncert BKG'
    model_sys.add_lognormal_uncertainty('SingleTop_rate', rate_unc_SingleTop, procname='SingleTop_mergedTop_2018',obsname='*')
    model_sys.add_lognormal_uncertainty('SingleTop_rate', rate_unc_SingleTop, procname='SingleTop_semimerged_2018',obsname='*')
    model_sys.add_lognormal_uncertainty('SingleTop_rate', rate_unc_SingleTop, procname='SingleTop_notmerged_2018',obsname='*')
    model_sys.add_lognormal_uncertainty('WJets_rate', rate_unc_WJets, procname='WJets_2018',obsname='*')
    model_sys.add_lognormal_uncertainty('DY_rate', rate_unc_DY, procname='DYJets_2018',obsname='*')
    model_sys.add_lognormal_uncertainty('QCD_rate', rate_unc_QCD, procname='QCD_2018',obsname='*')
    # model_sys.add_lognormal_uncertainty('BKG_rate', rate_unc_BKG, procname='Backgrounds_2018',obsname='*')
